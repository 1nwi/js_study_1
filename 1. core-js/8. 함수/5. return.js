...
var r1 = add(5, 7);    //  add(5, 7) 는 12;
console.log(r1);

// 호출순서 안쪽에서 밖 , 같은 라인일 때 왼쪽에서 오른쪽
var r2 = add(add(1,2), add(3, add(3, 1)));
console.log(r2);

console.log("==========================");

// return값이 ㅇ벗는 함수는 아무것도 가져오지 않기 때문에
// 변수에 저장할 수 없고, 다른 함수의 인수로도 저장 불가능
multi(3, 5);
var r3 = multi(3, 5);
console.log(`r3: ${r3}`);
...
// 함수의 리턴값은 언제나 하나!
// 그런데 2개의 정수를 전달 받아서, + - * / 의 4가지 결과를 리턴받고 싶다?
